  ...
  return (
    <div className="space-y-4 bg-slate-800 rounded-3xl p-8 outline outline-1 outline-slate-700 shadow-lg">
      ...
      <p className="text-md leading-relaxed text-terciary">
        ...
        academic background is in agronomy, it was during my research projects,
        where I used tools like <span className="text-primary">R</span> and{" "}
      ...
      <p className="text-md leading-relaxed text-terciary">
        ...
        <span className="text-primary">software development</span>. I am eager
        to join a team where I can contribute to creating{" "}
      ...
      <p className="text-md leading-relaxed text-terciary">
        ...
        <span className="text-primary">personal projects</span> and also I've
        been learning <span className="text-primary">TypeScript, NodeJS and Figma</span> on my own.
      </p>
    </div>
  );
};

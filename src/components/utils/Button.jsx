export const Button = ({ ariaLabel, text, toSection }) => {
  return (
<a href={ toSection } aria-label={ariaLabel} className="relative items-center justify-start inline-block px-5 py-3 overflow-hidden font-bold rounded-2xl group cursor-pointer">
